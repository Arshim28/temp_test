    ...
    if (!activeLayers.find(activeLayer => activeLayer.id === layer.id)) {
      ...
      map.on('click', `layer-${layer.id}`, (e) => {
        ...
        if (feature) {
          ...
          const khata_no = props.khata_no;
          console.log("khata_no raw value:", khata_no);
    ...
    <div className="map-container">
      ...
      <div className="map-wrapper">
        ...
        {selectedFeatureData && (
            ...
            <button className="close-button" onClick={() => setSelectedFeatureData(null)}>
              ✖
            </button>
            ...
            {/* Wrap feature info in a "box" */}
            <div className="feature-info-box">
              <h3>Feature Information</h3>
              <div className="feature-details">
                {Object.entries(Object.fromEntries(Object.entries(selectedFeatureData).slice(0,5))).map(([key, value]) => (
                  <p key={key}>
